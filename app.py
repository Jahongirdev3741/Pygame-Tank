...
class Boolet:
  ...
  def draw(self, win: pygame.Surface, tank: Tank):
...
class Enemy(Tank):
  ...
  def __init__(self, width, height, speed):
    super().__init__(width, height, random.randint(0, WIDTH - 80), random.randint(0, HEIGHT - 80), speed)
    self.inter = 30
